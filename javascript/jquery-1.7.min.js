(function (a, b) {
    ...
    function br(a, b) {
        b.src ? f.ajax({
            ...
            .replace(bi, "/*$0*/")), b.parentNode && b.parentNode.removeChild(b);
    }
    ...
    var c = a.document,
        ...
        f = function () {
            ...
            e.fn = e.prototype = {
                ...
                slice: function () {
                    return this.pushStack(G.apply(this, arguments), "slice", G.call(arguments)
                        .join(","));
                },
                map: function (a) {
                ...
                ready: function (a) {
                    if (a === !0 && !--e.readyWait || a !== !0 && !e.isReady) {
                        ...
                        B.fireWith(c, [e]), e.fn.trigger && e(c)
                            .trigger("ready")
                            .unbind("ready");
                    }
                },
    ...
    f.extend({
        Deferred: function (a) {
            var b = f.Callbacks("once memory"),
                ...
                g = {
                    ...
                    always: function () {
                        return i.done.apply(i, arguments)
        ...
        g = c.createElement("select"), h = g.appendChild(c.createElement("option")), i = a.getElementsByTagName("input")[0], k = {
            ...
            unknownElems: !! a.getElementsByTagName("nav")
                .length,
            checkOn: i.value === "on",
        ...
        try {
            ...
            .fireEvent("onclick")), i = c.createElement("input"), i.value = "t", i.setAttribute("type", "radio"), k.radioValue = i.value === "t", i.setAttribute("checked", "checked"), a.appendChild(i), l = c.createDocumentFragment(), l.appendChild(a.lastChild), k.checkClone = l.cloneNode(!0)
            .cloneNode(!0)
    ...
    f.event = {
        ...
        remove: function (a, b, c, d) {
            ...
            if ( !! e && !! (m = e.events)) {
                ...
                for (g = 0; g < b.length; g++) {
                    ...
                    n = f.event.special[i] || {}, i = (d ? n.delegateType : n.bindType) || i, p = m[i] || [], k = p.length, j = j ? new RegExp("(^|\\.)" + j.split(".")
                        .sort()
                        .join("\\.(?:.*\\.)?") + "(\\.|$)") : null;
        ...
        dispatch: function (c) {
            ...
            if (e && !c.target.disabled && (!c.button || c.type !== "click")) for (m = c.target; m != this; m = m.parentNode || this) {
                    o = {}, q = [];
                    for (k = 0; k < e; k++) r = d[k], s = r.selector, t = o[s], r.isPositional ? t = (t || (o[s] = f(s)))
                            .index(m) >= 0 : t === b && (t = o[s] = r.quick ? K(m, r.quick) : f(m)
                            .is(s)), t && q.push(r);
                    q.length && j.push({
                        elem: m,
                        matches: q
            ...
            for (k = 0; k < j.length && !c.isPropagationStopped(); k++) {
                ...
                for (l = 0; l < p.matches.length && !c.isImmediatePropagationStopped(); l++) {
                    r = p.matches[l];
                    if (h || !c.namespace && !r.namespace || c.namespace_re && c.namespace_re.test(r.namespace)) c.data = r.data, c.handleObj = r, n = (i || r.handler)
    ...
    f.fn.extend({
        ...
        is: function (a) {
            return !!a && (typeof a == "string" ? T.test(a) ? f(a, this.context)
    ...
    bj.optgroup = bj.option, bj.tbody = bj.tfoot = bj.colgroup = bj.caption = bj.thead, bj.th = bj.td, f.support.htmlSerialize || (bj._default = [1, "div<div>", "</div>"]), f.fn.extend({
        ...
        remove: function (a, b) {
            for (var c = 0, d;
            (d = this[c]) != null; c++) if (!a || f.filter(a, [d])
    ...
    bY = bT.exec(bX.toLowerCase()) || [], f.fn.extend({
        ...
        ajax: function (a, c) {
            ...
            h.promise(v), v.success = v.done, v.error = v.fail, v.complete = i.add, v.statusCode = function (a) {
                ...
                .replace(bI, "")
                .replace(bN, bY[1] + "//"), d.dataTypes = f.trim(d.dataType || "*")
                .toLowerCase()
                .split(bR), d.crossDomain == null && (r = bT.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == bY[1] && r[2] == bY[2] && (r[3] || (r[1] === "http:" ? 80 : 443)) == (bY[3] || (bY[1] === "http:" ? 80 : 443)))), d.data && d.processData && typeof d.data != "string" && (d.data = f.param(d.data, d.traditional)), ca(bV, d, c, v);
            if (s === 2) return !1;
